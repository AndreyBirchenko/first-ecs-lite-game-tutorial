...
Если вы сделали всё правильно то у вас появилась папка Game. Внутри неё ещё две папки: Content - место где будут храниться ассеты и префабы и Runtime место для скриптов.
